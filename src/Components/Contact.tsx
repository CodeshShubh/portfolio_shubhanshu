...
export default function Contact() {
    ...
    return (
        <div className="text-center">
            {/* ✅ Added Toaster once at root (to show all toasts) */}
          ...
          [&>*]:border-gray-700
            ...
            [&_*::placeholder]:text-transparent
                "
                action={"https://formsubmit.co/shubhanshu.saadhiyaan@gmail.com"}
                method="post"
                onSubmit={handleSubmit}
            >
                {/* Prevent redirection -This is specific to FormSubmit.co service. */}
                ...
                <textarea name="message" className="w-2/3 h-40 resize-none" placeholder="Message" />
                <button type="submit" className=" bg-green-800 font-bold text-black cursor-pointer hover:bg-green-600 transition duration-1000">Get In Touch</button>
            </form>
